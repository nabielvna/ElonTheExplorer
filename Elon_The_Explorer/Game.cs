...
namespace Elon_The_Explorer
{
    public class Game
    {
        ...
        public void StartScreen()
        {
            ...
            ClearScreen();
            PrintStringCenter("Space Invaders", mainBrush, titleFont, dimension / 2, 50);
        ...
        public void Credits()
        {
            ...
            PrintStringCenter("Programmer & disigner: Marek Nagy", mainBrush, mainFont,
                dimension / 2, 3 * dimension / 20);
            PrintStringCenter("Made as project for MFF UK", mainBrush, mainFont,
